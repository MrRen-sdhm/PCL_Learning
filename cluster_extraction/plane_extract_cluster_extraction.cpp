...
main (int argc, char** argv)
{
    ...
    reader.read ("Kinect2_XYZ_3.pcd", *cloud);
    ...
    seg.setModelType (pcl::SACMODEL_PLANE);    //分割模型平面模型
    seg.setMethodType (pcl::SAC_RANSAC);       //随机采样一致性参数估计方法
    seg.setMaxIterations (100);                //最大的迭代的次数
    seg.setDistanceThreshold (0.006);          //设置符合模型的内点阀值
    ...
    // 桌子平面上的点云团使用欧式聚类的算法、kd树搜索对点云聚类分割
    ...
    viewer.setBackgroundColor (255, 255, 255); //背景颜色白色
